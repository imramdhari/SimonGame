...
public class SimonGameUi extends JFrame implements SimonObserver,ActionListener
{
	...
	SimonGame simon;
	JPanel colorButtonsPanel,controlButtonsPanel,scoreBoard,playerBoard;
	JButton quitButton,restartButton,configure;
	JButton redButton,blueButton,greenButton,yellowButton;
	Vector<JButton> colorButtons;

	JLabel labelScore,score,playername,Labelplayername;
	...
	ColorStateContext cs = new ColorStateContext();
	...
	public SimonGameUi(SimonGame simongame)
	{
		...
		configure = new JButton("Configuration");
		configure.addActionListener(new ActionListener()
		{
            public void actionPerformed(ActionEvent e)
            {
            	ClassFrame settings = new ClassFrame();
            	try
                {
		...
		controlButtonsPanel.add(configure);
		//add score Board
	...
	{  
		if (simon.currentPlayer.getSpeed()=="low") {
			button_speed = 500;
	    }
		else if (simon.currentPlayer.getSpeed()=="medium") {
			button_speed = 1000;
	   }
		else if (simon.currentPlayer.getSpeed()=="high") {
			button_speed = 2000;
		}
		else {
			button_speed = 1000;
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		sequence */
		if(cs.getState() instanceof Unlocked)
		{
	...
	public void gameOver(boolean isGameOver)
	{
		if(isGameOver)
		{
			JOptionPane.showMessageDialog(this,(SimonGame.playerName+" You Lose"));
			restart();
		}
	}
