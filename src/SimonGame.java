...
public class SimonGame implements Subject
{
	...
	static String Pname ="Lucia";
   static	String speed= "low";
  static	int buttons=1;
	
	//Stores the current length of the Color Sequence
	
	
	static Player currentPlayer=new Player(Pname,speed,buttons);
	int sequenceLength = currentPlayer.getButtons();
	static String playerName=currentPlayer.getName();
	...
	ColorStateContext current = new ColorStateContext();
	...
	public void play()
	{
		...
		for(int i = 0 ; i < sequenceLength ; i++)
		{
			...
			current.setColorState(new Locked());
		}
		notifyObservers();
		current.setColorState(new Unlocked());
	}
	 ...
	 */
	public void mapColor(int randomColor)
	{
		if(randomColor ==  0)
	...
	public void restart()
	{   
		sequenceLength = currentPlayer.getButtons();
